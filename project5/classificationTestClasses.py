...
def readSuicideData(trainingSize=100, testSize=100):
    ...
    # Schrum: For some reason the pickled AgentStates are missing the numReturned attribute, which should default to 0
...
class MultipleChoiceTest(testClasses.TestCase):
    ...
    def execute(self, grades, moduleDict, solutionDict):
        ...
        # Schrum: Had to encode studentSolution to avoid error
